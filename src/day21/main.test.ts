...
test("21-1-test", () => {
  if (inputTest.isSuccess) {
    expect(Day21.partOne(inputTest.value)).toBe(0);
  } else {
...
test("21-1-real", () => {
  if (inputReal.isSuccess) {
    expect(Day21.partOne(inputReal.value)).toBe(0);
  } else {
...
test("21-2-test", () => {
  if (inputTest.isSuccess) {
    expect(Day21.partTwo(inputTest.value)).toBe(0);
  } else {
    console.error(inputTest.error);
  }
});
...
test("21-2-real", () => {
  if (inputReal.isSuccess) {
    expect(Day21.partTwo(inputReal.value)).toBe(0);
  } else {
    console.error(inputReal.error);
  }
});
