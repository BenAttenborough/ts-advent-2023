...
test("16-1-test", () => {
  if (inputTest.isSuccess) {
    expect(Day16.partOne(inputTest.value)).toBe(0);
  } else {
...
test("16-1-real", () => {
  if (inputReal.isSuccess) {
    expect(Day16.partOne(inputReal.value)).toBe(0);
  } else {
...
test("16-2-test", () => {
  if (inputTest.isSuccess) {
    expect(Day16.partTwo(inputTest.value)).toBe(0);
  } else {
    console.error(inputTest.error);
  }
});
...
test("16-2-real", () => {
  if (inputReal.isSuccess) {
    expect(Day16.partTwo(inputReal.value)).toBe(0);
  } else {
    console.error(inputReal.error);
  }
});
