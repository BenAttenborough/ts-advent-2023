...
test("09-1-test", () => {
  if (inputTest.isSuccess) {
    expect(Day09.partOne(inputTest.value)).toBe(0);
  } else {
...
test("09-1-real", () => {
  if (inputReal.isSuccess) {
    expect(Day09.partOne(inputReal.value)).toBe(0);
  } else {
...
test("09-2-test", () => {
  if (inputTest.isSuccess) {
    expect(Day09.partTwo(inputTest.value)).toBe(0);
  } else {
    console.error(inputTest.error);
  }
});
...
test("09-2-real", () => {
  if (inputReal.isSuccess) {
    expect(Day09.partTwo(inputReal.value)).toBe(0);
  } else {
    console.error(inputReal.error);
  }
});
