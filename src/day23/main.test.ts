...
test("23-1-test", () => {
  if (inputTest.isSuccess) {
    expect(Day23.partOne(inputTest.value)).toBe(0);
  } else {
...
test("23-1-real", () => {
  if (inputReal.isSuccess) {
    expect(Day23.partOne(inputReal.value)).toBe(0);
  } else {
...
test("23-2-test", () => {
  if (inputTest.isSuccess) {
    expect(Day23.partTwo(inputTest.value)).toBe(0);
  } else {
    console.error(inputTest.error);
  }
});
...
test("23-2-real", () => {
  if (inputReal.isSuccess) {
    expect(Day23.partTwo(inputReal.value)).toBe(0);
  } else {
    console.error(inputReal.error);
  }
});
